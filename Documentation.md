...
#### Duplicate Code im ShowDoctorExaminationPlaCommand
m vorliegenden Code findet sich der Code Smell "Duplicated Code". Dieser manifestiert sich in der ShowDoctorExaminationPlanCommand Klasse, wo die Formatierung der Ausgabe für jedes ExaminationWithPatientName Objekt manuell im execute() Methode erfolgt. Anstattdessen existiert in der Klasse ExaminationWithPatientName bereits eine toString() Methode, die genau diese Formatierung implementiert.
